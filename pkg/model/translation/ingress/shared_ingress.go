...
import "github.com/ccfish2/controllerPoweredByDI/pkg/model/translation"
...
func NewSharedIngressTranslator(name, namespace, secretsNamespace string, enforceHTTPs bool, useProxyProtocol bool, idleTimeoutSeconds int) translation.Translator {
	return translation.NewTranslator(name, namespace, secretsNamespace, enforceHTTPs, useProxyProtocol, false, idleTimeoutSeconds, true, false)
}
